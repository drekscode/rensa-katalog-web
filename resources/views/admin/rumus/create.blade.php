...
@section('content')
<div class="mx-auto max-w-3xl" x-data="{ selectedRumus: '{{ old('rumus', '') }}' }">
            ...
            <div class="px-4 py-6 sm:p-8">
                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8">
                    ...
                    <div class="col-span-full" x-show="selectedRumus === 'Rumus Batang' || selectedRumus === 'Rumus Box'" x-cloak>
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="mt-2 relative">
                                    <input type="number" step="0.01" min="0" name="panjang" id="panjang" value="{{ old('panjang') }}"
                            ...
                            <div>
                                ...
                                <div class="mt-2 relative">
                                    <input type="number" step="0.01" min="0" name="lebar" id="lebar" value="{{ old('lebar') }}"
                                         :required="selectedRumus === 'Rumus Batang' || selectedRumus === 'Rumus Box'"
                    ...
                    <div class="col-span-full" x-show="selectedRumus === 'Rumus Box'" x-cloak>
                        ...
                        <div class="mt-2 relative">
                            <input type="number" step="1" min="1" name="lembar" id="lembar" value="{{ old('lembar') }}"
