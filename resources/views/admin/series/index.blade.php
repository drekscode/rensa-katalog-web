...
<div x-data="{ 
    ...
    <div class="sm:flex sm:items-center justify-between gap-4">
        <div class="sm:flex-auto">
            <p class="mt-2 text-sm text-gray-600">A list of all series in your catalog.</p>
        </div>

        <!-- Search Bar -->
        <div class="mt-4 sm:mt-0 flex-1 max-w-md">
            <form action="{{ route('admin.series.index') }}" method="GET" class="relative" id="searchFormSeries">
                ...
                <input type="text" 
                       ...
                       @input="document.getElementById('searchFormSeries').submit()"
                       ...
                       placeholder="Search series by name or category...">
            </form>
        </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50/50">
                            <tr>
                                ...
                                <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Nama Series</th>
                                        ...
                                        <form action="{{ route('admin.series.destroy', $s) }}" 
                                            ...
                                            <button type="button" 
                                                    @click="$dispatch('confirm-delete', { 
                                                        title: 'Delete Series?', 
                                                        message: 'Are you sure you want to delete \'{{ addslashes($s->nama_series) }}\'? This will permanently remove it and all related data.',
                            ...
                            <tr>
                                <td colspan="5" class="px-3 py-12 text-center text-sm text-gray-500">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-900 font-medium mb-1">No series found</p>
                                        <p class="text-gray-500 mb-4">Get started by creating a new series.</p>
                                        <a href="{{ route('admin.series.create') }}" class="text-[#8b9b7e] hover:text-[#7a8a6f] font-medium">Create series →</a>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
