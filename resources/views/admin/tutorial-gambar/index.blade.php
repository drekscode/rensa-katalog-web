...
@section('title', 'Tutorial Gambar')
@section('page-title', 'Tutorial Gambar')
...
<div x-data="{ 
    ...
    <div class="sm:flex sm:items-center justify-between gap-4">
        <div class="sm:flex-auto">
            <p class="mt-2 text-sm text-gray-600">A list of all tutorial gambar in your catalog.</p>
        </div>

        <!-- Search Bar -->
        <div class="mt-4 sm:mt-0 flex-1 max-w-md">
            <form action="{{ route('admin.tutorial-gambar.index') }}" method="GET" class="relative" id="searchFormTutorialGambar">
                ...
                <input type="text" 
                       ...
                       @input="document.getElementById('searchFormTutorialGambar').submit()"
                       ...
                       placeholder="Search tutorial by title or category...">
            </form>
        </div>

        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
            <a href="{{ route('admin.tutorial-gambar.create') }}" 
                ...
                <div class="overflow-hidden shadow-sm ring-1 ring-gray-200 rounded-xl bg-white">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            @forelse($tutorial_gambars as $tg)
                            ...
                            <tr>
                                <td colspan="7" class="px-3 py-12 text-center text-sm text-gray-500">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-900 font-medium mb-1">No tutorial gambar found</p>
                                        <p class="text-gray-500 mb-4">Get started by creating a new tutorial gambar.</p>
                                        <a href="{{ route('admin.tutorial-gambar.create') }}" class="text-[#8b9b7e] hover:text-[#7a8a6f] font-medium">Create tutorial →</a>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
