...
<div class="mx-auto max-w-3xl">
    <form action="{{ route('admin.hasil-pasang.update', $hasilPasang->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="overflow-hidden bg-white shadow-sm ring-1 ring-gray-200 rounded-xl">
             <div class="border-b border-gray-100 bg-gray-50/50 px-4 py-4 sm:px-6">
                ...
                <p class="mt-1 text-sm text-gray-500">Update the project information below.</p>
            </div>
