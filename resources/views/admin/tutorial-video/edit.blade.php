...
@section('title', 'Edit Tutorial Video')
@section('page-title', 'Edit Tutorial Video')

@section('content')
<div class="mx-auto max-w-3xl">
    <form action="{{ route('admin.tutorial-video.update', $tutorial_video) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="overflow-hidden bg-white shadow-sm ring-1 ring-gray-200 rounded-xl">
            <div class="border-b border-gray-100 bg-gray-50/50 px-4 py-4 sm:px-6">
                ...
                <p class="mt-1 text-sm text-gray-500">Update the video tutorial information below.</p>
            </div>
            <div class="px-4 py-6 sm:p-8">
                <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8">
                        ...
                        <div class="mt-2 relative">
                            <select id="kategori_id" name="kategori_id" required
                                ...
                                @foreach($kategoris as $kategori)
                                    <option value="{{ $kategori->id }}" {{ old('kategori_id', $tutorial_video->kategori_id) == $kategori->id ? 'selected' : '' }}>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2 relative">
                            <input type="text" name="link" id="link" value="{{ old('link', $tutorial_video->link) }}" required
