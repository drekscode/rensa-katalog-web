    ...
    <form action="{{ route('admin.kategori.store') }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white shadow-sm ring-1 ring-gray-200 rounded-xl overflow-hidden">
            <div class="border-b border-gray-100 bg-gray-50/50 px-4 py-4 sm:px-6">
                ...
                <p class="mt-1 text-sm text-gray-500">Enter the category details below.</p>
            </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-2">
                            <textarea name="keunggulan_produk" 
                                      ...
                                      rows="5"
                                      class="block w-full rounded-lg border-0 py-3 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#8b9b7e] sm:text-sm sm:leading-6 transition-all duration-200">{{ old('keunggulan_produk') }}</textarea>
                        </div>
