                        ...
                        <div class="w-full text-left">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="col-span-full aspect-video rounded-xl overflow-hidden bg-gray-100 relative mb-4">
                                     ...
                                     <template x-if="!selectedItem.image">
                                         <div class="w-full h-full flex flex-col items-center justify-center bg-gray-50 text-gray-455">
                                             <svg class="h-10 w-10 text-gray-300 mb-1" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                                 <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                                             </svg>
                                             <span class="text-xs text-gray-400 italic">No Image</span>
                                         </div>
