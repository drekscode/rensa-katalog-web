...
<div x-data="{
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
             <form action="{{ route('admin.survey-request.index') }}" method="GET" class="relative">
            ...
            <div class="w-full sm:w-48">
                <form action="{{ route('admin.survey-request.index') }}" method="GET">
                    ...
                    <select name="status" onchange="this.form.submit()"
                            class="block w-full rounded-xl border-0 py-2.5 px-3 text-gray-900 ring-1 ring-inset ring-gray-200 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-[#8b9b7e] sm:text-sm sm:leading-6 transition-all">
